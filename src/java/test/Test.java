...
public class Test {
    ...
    public static void main(String[] args) throws EntityNotFoundException {
        ...
        Person p = facade.createPerson("Jacob", "Simonsen", "jac.ufo@icloud.com");
        ...
        p = facade.createAddressForPerson(p, "Thisway", "no Info", 3070);
        System.out.println("createAddressForPerson: Zipcode= " + p.getAddress().getCityInfo().getZip());
        ...
        System.out.println("getAllpersoninCity: All persons in city = 3070");
        ...
        Company c1 = facade.createCompany("McDonalds", "Dette er ikke Donalds", 13597562, 10, 999, "mcdonald@funfun.com");
