...
public class TestPopulate {
    ...
    public static void main(String[] args) throws EntityNotFoundException {
        ...
        Person p1 = f.createPerson("Jonas", "Simonsen","jks.ufo@icloud.dk");
        p1 = f.createAddressForPerson(p1, "Parkvej", "4", 3070);
        p1 = f.addPhonePerson(p1, "Home", 27826910);
        Hobby h = f.createHobbies("Drone", "Flyve over skyerne");
        p1 = f.addHobbyToPerson(p1, h);
        
        Person p2 = f.createPerson("Andreas", "Larsen","and@mail.dk");
        ...
        Person p3 = f.createPerson("Christian", "Lind","kurt@mail.dk");
        p3 = f.createAddressForPerson(p3, "Lindegade", "6", 2800);
        p3 = f.addPhonePerson(p3, "Home", 44335544);
        p3 = f.addHobbyToPerson(p3, h1);
        
        Person p4 = f.createPerson("Peter", "Pedersen","Peter@mail.dk");
        p4 = f.createAddressForPerson(p4, "Pedersengade", "7", 3300);
